package my.spotit.asset.integration.mobile.dashboard;

import my.spotit.asset.dashboard.api.controller.DashboardTransformer;
...
public class IntegrationDashboardController {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(IntegrationDashboardController.class);

    private DashboardService dashboardService;
    private DashboardTransformer dashboardTransformer;

    @Autowired
    public IntegrationDashboardController(DashboardService dashboardService,
