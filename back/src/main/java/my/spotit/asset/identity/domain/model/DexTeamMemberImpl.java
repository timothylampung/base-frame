...
@Table(name = "DEX_TEAM_MMBR")
public class DexTeamMemberImpl implements DexTeamMember {

    @Id
    @Column(name = "ID", nullable = false)
    @GeneratedValue(generator = "SQ_DEX_TEAM_MMBR")
    @SequenceGenerator(name = "SQ_DEX_TEAM_MMBR", sequenceName = "SQ_DEX_TEAM_MMBR", allocationSize = 1)
    private Long id;
